...
public class UtilityPattern extends LandablePattern implements ChargeablePattern, Groupable {
    ...
    public UtilityPattern(UtilityRegionPattern region, String name, int basicPrice, int[] color) {
        super(color);
        this.region = region;
        this.name = name;
